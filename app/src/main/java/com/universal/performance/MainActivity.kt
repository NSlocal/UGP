...
class MainActivity : AppCompatActivity() {
    ...
    private var showStatusOverlay = true // 🆕 Fitur 5: Show Status Active = Overlay!

    private var simulatedCpu = 35.0
    private var simulatedGpu = 40.0
    private val random = java.util.Random()

    // === FLOATING OVERLAY — TETAP MUNCUL DI ATAS SEMUA LAYAR! ===
        ...
        overlayToggle = Switch(this).apply {
            ...
            setOnCheckedChangeListener { _, isChecked ->
                ...
                Toast.makeText(this@MainActivity,
                    if (isChecked) "Overlay AKTIF ✅ — Buka Game, angka tetap muncul di atas! 🎮"
        ...
        fpsCallback = object : android.view.Choreographer.FrameCallback {
            override fun doFrame(frameTimeNanos: Long) {
                ...
                if (elapsed >= fpsUpdateInterval) {
                    ...
                    overlayFps?.text = capped.toString() // Update overlay juga!
                    frameCount = 0
    ...
    private fun updateCpuGpu() {
        ...
        overlayCpu?.text = "$cpuInt%" // Update overlay juga!
        overlayGpu?.text = "$gpuInt%" // Update overlay juga!
    }
    ...
    // ✅ PERMISSION UNTUK FLOATING OVERLAY
    private fun checkOverlayPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !android.provider.Settings.canDrawOverlays(this)) {
            ...
            Toast.makeText(this, "⚠️ Izinkan 'Tampil di atas aplikasi' untuk menampilkan overlay di game!", Toast.LENGTH_LONG).show()
        } else {
            showFloatingOverlay()
        }
    }

    // ✅ FLOATING OVERLAY — MUNCUL DI ATAS SEMUA LAYAR! BISA DIGESER!
    private fun showFloatingOverlay() {
        ...
        // FPS — HIJAU, KECIL, TEBAL, PERSIS GAMBAR!
        ...
        Toast.makeText(this, "✅ Overlay Aktif! Buka Game, angka tetap muncul di atas! 🎮", Toast.LENGTH_LONG).show()
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_OVERLAY_PERMISSION) {
            if (android.provider.Settings.canDrawOverlays(this)) {
                ...
                Toast.makeText(this@MainActivity, "❌ Permission ditolak, overlay tidak bisa ditampilkan", Toast.LENGTH_SHORT).show()
            }
        }
    }
